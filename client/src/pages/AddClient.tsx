      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-slate-700 dark:text-slate-100 flex items-center gap-2">
                <Briefcase size={14} className="text-primary-500" /> Business Type
              </label>
              <input
                type="text"
                name="businessType"
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-slate-700 dark:text-slate-100 flex items-center gap-2">
                <Calendar size={14} className="text-primary-500" /> Meeting Date
              </label>
              <input
                type="date"
                name="meetingDate"
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-slate-700 dark:text-slate-100 flex items-center gap-2">
                <CheckCircle2 size={14} className="text-primary-500" /> Initial Status
              </label>
              <select
                name="status"
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-slate-700 dark:text-slate-100 flex items-center gap-2">
              <StickyNote size={14} className="text-primary-500" /> Notes / Description
            </label>
            <textarea
              name="notes"
              rows={4}
          ...
          <div className="flex justify-end gap-3 pt-4">
            <button
              ...
              className="px-6 py-3 rounded-xl font-bold text-slate-600 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all flex items-center gap-2"
            >
              <X size={18} /> Cancel
            </button>
            <button
